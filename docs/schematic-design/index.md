...
- **TLV431 grade never upgraded to TLV431B (±0.5%)**, and R30/R31 still need 0.5% parts + LCSC numbers - together they're the ±157mV error budget against 180mV of margin - [power](power.md#threshold-detector---lm2903-u11)
